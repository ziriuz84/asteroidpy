...
def weather(config):
    ...
    data, deltaT, cloudcover, seeing, transparency, lifted_index, temperature, rh, wind10m, prec_type = [], [],[],[],[],[],[],[],[],[]
    ...
    for time in weather_forecast['dataseries']:
        ...
        deltaT.append(weather_time(weather_forecast['init'], time['timepoint']))
